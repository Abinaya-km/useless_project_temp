...
For Software:
Languages used: Python (backend), TypeScript/JavaScript (frontend)
Frameworks used: FastAPI (backend), React + Vite (frontend)
Libraries used: pypdf (backend PDF processing), Tailwind CSS and lucide-react (frontend styling/icons)
Tools used: Render (deployment), Git/GitHub (version control)
...
## Team Contributions
- Abinaya K M: Design and Front-end
- Abhiram R: Idea and Back-end integration
